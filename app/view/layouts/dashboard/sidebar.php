...
<a class="sidebar-brand d-flex align-items-center justify-content-center mt-3" href="#">
        ...
        <div class="sidebar-brand-text mx-6">Pembayaran spp smk n 1 denpasar</div>
    </a>
   ...
   <li class="nav-item active">
    ...
    <!-- <hr class="sidebar-divider mb-7 mt-7"> -->

    <?php if($_SESSION['userSession']['role'] !== 'siswa') : ?>
     <!-- Heading -->
    ...
    <!-- Heading -->
    <div class="sidebar-heading" style="color: #eaeaea bold">ACTIONS</div>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $_SESSION['userSession']['username'] ?></span>
